...
export default function AccountDashboardSr({ user }: Props) {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 500000) {
      alert('Slika je prevelika. Koristite sliku manju od 500KB.');
      return;
    }
    ...
    try {
      ...
      reader.onload = async (event) => {
        ...
        if (res.ok) {
          ...
          alert(error.error || 'Neuspešno otpremanje slike');
        }
      ...
      alert('Neuspešno otpremanje slike');
      setIsUploadingAvatar(false);
    }
  };
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto px-4 pt-8 pb-6">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            {/* Upload hint text */}
            <p className="text-[10px] text-zinc-600 mb-2">Dodirnite za promenu slike</p>
