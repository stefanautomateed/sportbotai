 ...
 * Features staggered animations for smooth loading feel.
 */
...
import { useStaggeredAnimation } from '@/components/ui';
...
// Individual match item with staggered animation
function MatchItem({
  match,
  index,
  isSelected,
  ...
  const stagger = useStaggeredAnimation(index, 40, 50);
